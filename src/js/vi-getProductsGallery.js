...
//   refs.mobileButton.addEventListener('click', getNewFething);
// }
...
function parceCategoryList(arg) {
  ...
  refs.categoryPageLink = document.querySelectorAll('.cg-category-link .text');
...
export function fetchOnError(arg = 'ERROR') {
  console.log(arg);
}
